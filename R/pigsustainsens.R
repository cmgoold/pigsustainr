...
#' to a change in a parameter. 
#' We can approximate for any ODE model computationally, which is what the function
#' below provides. The raw sensitivity value is multiplied by the ratio of the 
#' parameter to the original solution, which normalises the sensitivity value. 
#'@export
